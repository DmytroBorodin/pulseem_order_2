...
let selectOptionBlock = page2Wrap.querySelector('.select__options__block');
let selectTitle = page2Wrap.querySelector('.select__title');
let optionsArr = [...selectOptionBlock.querySelectorAll('.option')];

selectBlockP2.addEventListener('click', () => {
	selectOptionBlock.classList.toggle('active');
});
